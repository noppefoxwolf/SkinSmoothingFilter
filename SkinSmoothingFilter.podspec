#
# Be sure to run `pod lib lint SkinSmoothingFilter.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'SkinSmoothingFilter/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SkinSmoothingFilter' => ['SkinSmoothingFilter/Assets/*.png']
  # }
